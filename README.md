...
The system starts by reading sales data from a CSV file using the Pandas library.

It calculates the total sales for each product by multiplying quantity and price.

The analyzed data is then visualized as a bar chart using Matplotlib.

The generated graph is saved as an image file.

Using the ReportLab library, the program creates a PDF report.

The graph image and sales summary are inserted into the PDF.

The final output is a professionally formatted PDF report generated automatically.
